...
using Resthopper.Models;


namespace Resthopper
{
    //Resthopper was first developed on October 25-26, 2018 at the TT AEC Hackathon in NYC. 
    //The prototype was released at github.com/RESThopper/resthopper.compute under the GNU GPL v3 license.
    //Sergey Pigach and David Mans continued development on a version that was eventually merged with McNeel's codebase.
    //The version here is based on their code as released by McNeel under the MIT license. (Accessed on February 8, 2019.)

    public class Resthopper
    {
        public static Response Grasshopper(NancyContext ctx)
        {
            ...
            ResthopperSchema input = JsonConvert.DeserializeObject<ResthopperSchema>(json);
            ...
            foreach (var obj in definition.Objects)
            {
                ...
                if (group.NickName.Contains("RH_IN"))
                {
                    ...
                    // SetData
                    foreach (Models.DataTree<ResthopperObject> tree in input.Values)
                    {
            ...
            ResthopperSchema OutputSchema = new ResthopperSchema();
            ...
            foreach (var obj in definition.Objects)
            {
                ...
                if (group.NickName.Contains("RH_OUT"))
                {
                    ...
                    // Get data
                    Models.DataTree<ResthopperObject> OutputTree = new Models.DataTree<ResthopperObject>();
        ...
        public static void PopulateParam<DataType>(GH_Param<IGH_Goo> Param, Models.DataTree<ResthopperObject> tree)
        {
